...
var (
	...
	// reConnectionToTCP captures full TCP URL including credentials, IPv6, query params.
...
// ExtractErrorContext analyzes FFmpeg stderr and extracts structured error context.
